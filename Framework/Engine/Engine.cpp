...
// lighting effect is initialized in this function
...
//    // set the intensity of ambient light, not the position
	GLfloat global_ambient[] = {0.2, 0.2, 0.2, 1};
	glLightModelfv(GL_LIGHT_MODEL_AMBIENT, global_ambient);
////
////	// enable directional light lighting
////	// (x, y, z, 0.0) -> directional lighting: 平行光
...
//	GLfloat position[] = {1.0f, 1.0f, 1.0f, 0.0f};      // the position of the light, relative position, will change -> camera
...
//	glEnable(GL_LIGHT0);
    ...
    // this is a pure virtual function which I will need to implement in child 'Engine' class
	current->Initialise();
	time = 0;
